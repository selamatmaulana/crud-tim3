...
<body>
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li class="active"><a href="suratizinkp.php">
    ...
    <section class="dashboard">
        ...
        <p class="h5 margin" style="margin-top: 10vh !important;">TEMPLATE SURAT IZIN KP</p>

        <div class="dash-content">
            <div class="activity">
                <!-- <form action="" method="post"> -->
                <div class="activity" <div class="text-justify">
                    <a href="download.php"><button class="btn btn-primary btn-lg btn-block" name="submit"> UNDUH </button> </a>
                </div>
