...
<body>
  <nav>
    ...
    <div class="menu-items">
      <ul class="nav-links">
        ...
        <li class="active"><a href="nilai.php">
  ...
  <section class="dashboard">
    ...
    <p class="h5 margin" style="margin-top: 10vh !important;">Nilai</p>

    <div class="dash-content">
      <div class="activity">
        <!-- <form action="" method="post"> -->
        <div class="activity" <div class="text-justify">
          <a href="download.php"><button class="btn btn-primary btn-lg btn-block" name="submit"> VIEW </button> </a>
        </div>
